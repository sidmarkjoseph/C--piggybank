 ...
 * Public Interface
 *----------------------------------------------
 * getTok() - returns token on tokenizing a file
 * attach(std::istream*) - attachs istream* to a file
 * returnComments(bool) - returns Comments based on bool
 * setSpecialTokens(const std::string&) - sets Special Tokens
 * currentLineCount() - returns current Line Count
 *
 * Maintenance History:
 * --------------------
   ver 1.0 03/12/2016
   ver 3.0 April 7th 2016
 */
#include <iosfwd>
#include <string>
