...
/*
  ...
  ======================
   push(const element& item) - Push item onto the ScopeStack
   pop()- Pushes out item on the top of ScopeStack
   size()- returns size of ScopeStack;
   begin() - returns a pointer to the first element on the stack
   end() - returns a pointer to the last element on the stack
