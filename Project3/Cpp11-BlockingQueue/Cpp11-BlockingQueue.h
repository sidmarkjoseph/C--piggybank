...
// ver 1.0                                                   //
// Siddharth Joseph MS Computer Science Syracuse University  //
///////////////////////////////////////////////////////////////
/*
 * Package Operations:
 * -------------------
 ...
 * Public Interface
 *------------------------------
 *  deQ() - Removes work item from front of queue
 *  enQ(const T& t) - Pushes work item onto the queue
 *  front() - Returns work item at front of queue
